...
interface CustomerLoginScreenProps {
  navigation: NativeStackNavigationProp<AuthStackParamList, 'CustomerLogin'>;
}

export const CustomerLoginScreen: React.FC<CustomerLoginScreenProps> = ({ navigation }) => {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      // On success, RootNavigator switches to Customer Area automatically!
    } catch (err: any) {
      ...
      <ScrollView contentContainerStyle={styles.container} keyboardShouldPersistTaps="handled">
        <View style={styles.header}>
          <View style={styles.roleTag}>
            <Text style={styles.roleTagText}>🛍️ {t('roles.customer')}</Text>
          </View>
